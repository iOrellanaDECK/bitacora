            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                @auth
                    ...
                    <a href="{{ route('proyectos.create') }}"
                       class="inline-flex items-center gap-1.5 rounded-lg bg-indigo-600 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-indigo-700 transition-colors me-4">
                ...
                @else
                    ...
                    <a href="{{ route('register') }}" class="inline-flex items-center rounded-lg bg-indigo-600 px-4 py-2 text-sm font-medium text-white hover:bg-indigo-700 transition-colors">Registrarse</a>
                @endauth
            </div>
        ...
        @auth
            ...
            <div class="pt-4 pb-1 border-t border-gray-200">
                ...
                <div class="mt-3 space-y-1">
                    <x-responsive-nav-link :href="route('proyectos.create')">
                        + Nuevo proyecto
                    </x-responsive-nav-link>
